          ...
          <div className="bg-[#094770] w-full md:w-5/12 p-12 text-white flex flex-col justify-center">
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-xs text-blue-200 uppercase tracking-wider mb-1">Global Inquiries</p>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  <p className="text-xs text-blue-200 uppercase tracking-wider mb-1">General Correspondence</p>
                  <p className="font-semibold">strategy@capyngen.com </p>
                </div>
              </div>
            </div>
          </div>
