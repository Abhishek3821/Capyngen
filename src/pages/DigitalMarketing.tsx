    ...
    <div className="font-sans text-slate-800 bg-[#fbfcfd] min-h-screen">
        ...
        <div className="flex flex-col md:flex-row items-center gap-12">
          <div className="w-full md:w-1/2">
            ...
            <div className="flex gap-4">
              <button className="bg-[#0f4a8a] hover:bg-[#0c3968] text-white px-6 py-3 rounded text-sm font-medium transition-colors">
                Explore Growth
              </button>
              <button className="bg-transparent hover:bg-slate-50 text-[#0f4a8a] border border-[#0f4a8a] px-6 py-3 rounded text-sm font-medium transition-colors">
          ...
          <div className="w-full md:w-1/2 relative">
            ...
            {/* Floating Card */}
            <div className="absolute -bottom-6 -left-6 bg-white p-5 rounded-lg shadow-xl z-20 flex items-center gap-4 border border-slate-100 max-w-[280px]">
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          ...
          <div className="bg-[#eff5fb] p-10 rounded-2xl">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="p-6 border border-slate-100 rounded-xl hover:shadow-lg transition-shadow bg-[#fbfcfd] flex flex-col h-full">
                ...
                <a href="#" className="text-[#0f4a8a] text-sm font-semibold hover:underline flex items-center gap-1 mt-auto">
      ...
      <section className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 gap-6">
            ...
            <button className="text-[#0f4a8a] font-medium text-sm border-b border-[#0f4a8a] pb-1 hover:text-blue-800 transition-colors">
              Explore More
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { tag: "STRATEGY", title: "Smart Marketing in a Privacy-First World", desc: "Industry brands are now handling the damage of third-party cookies along with sustaining their procurement footprint. ", img: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" },
              { tag: "INSIGHT", title: "Making Content Feel Personal— With Automation", desc: "Maximizing generative versions to build plenty of unique ads that convert better than broad… ", img: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" },
              { tag: "CASE STUDY", title: "The $50M Climb: How We Are Scaling Our SaaS Together", desc: "At Capyngen, we moved beyond single-channel marketing to win major enterprise accounts. ", img: "https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80" }
            ].map((post, i) => (
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
            {[
              ...
              <div key={i} className="bg-slate-50 p-8 rounded-xl text-center">
          ...
          <div className="bg-[#0f4a8a] rounded-2xl p-10 md:p-16 text-center text-white relative overflow-hidden">
            ...
            {faqs.map((faq, index) => (
              <div key={index} className="bg-white rounded-lg shadow-sm border border-slate-100 overflow-hidden">
                <button
                  ...
                  className="w-full text-left px-6 py-5 font-semibold text-slate-800 hover:bg-slate-50 transition-colors flex justify-between items-center focus:outline-none"
                >
      ...
      <section className="py-24 px-6 bg-white">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row gap-16 rounded-2xl overflow-hidden shadow-2xl">
          <div className="w-full md:w-5/12 bg-[#0f4a8a] p-12 flex flex-col justify-center text-white">
            ...
            <form className="space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                  ...
                  <input type="text" className="w-full border-b border-slate-300 py-2 focus:outline-none focus:border-[#0f4a8a] transition-colors" />
                </div>
                <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                  ...
                  <input type="email" className="w-full border-b border-slate-300 py-2 focus:outline-none focus:border-[#0f4a8a] transition-colors" />
                </div>
                <div>
              ...
              <div>
                ...
                <textarea rows={3} className="w-full border-b border-slate-300 py-2 focus:outline-none focus:border-[#0f4a8a] transition-colors resize-none"></textarea>
              </div>
              
              <button type="submit" className="w-full bg-[#0f4a8a] hover:bg-[#0c3968] text-white py-4 rounded-md font-bold transition-colors mt-4">
                Submit
              </button>
            </form>
          </div>
